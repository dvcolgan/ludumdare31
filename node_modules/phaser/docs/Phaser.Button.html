...
<dt>
    <h4 class="name" id="onOverMouseOnly"><span class="type-signature"></span>onOverMouseOnly<span class="type-signature"></span></h4>
...
<table class="props table table-striped">
	...
	<tbody>
        ...
        <tr>
                ...
                <td class="name"><code>onOverMouseOnly</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If true then onOver events (such as onOverSound) will only be triggered if the Pointer object causing them was the Mouse Pointer.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="setFrames"><span class="type-signature"></span>setFrames<span class="signature">(<span class="optional">overFrame</span>, <span class="optional">outFrame</span>, <span class="optional">downFrame</span>, <span class="optional">upFrame</span>)</span><span class="type-signature"></span></h4>
