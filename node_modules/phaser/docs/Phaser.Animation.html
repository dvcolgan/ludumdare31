...
<dt>
    <h4 class="name" id="enableUpdate"><span class="type-signature"></span>enableUpdate<span class="type-signature"></span></h4>
...
<table class="props table table-striped">
	...
	<tbody>
        ...
        <tr>
                ...
                <td class="name"><code>enableUpdate</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Gets or sets if this animation will dispatch the onUpdate events upon changing frame.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="loopCount"><span class="type-signature"></span>loopCount<span class="type-signature"></span></h4>
...
<table class="props table table-striped">
	...
	<tbody>
        ...
        <tr>
                ...
                <td class="name"><code>loopCount</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The number of times the animation has looped since it was last started.</p></td>
        </tr>
...
<span class="param-type"><a href="Phaser.Signal.html">Phaser.Signal</a></span>
            ...
            <td class="description last"><p>This event is dispatched when this Animation completes playback. If the animation is set to loop this is never fired, listen for onAnimationLoop instead.</p></td>
        </tr>
...
<span class="param-type"><a href="Phaser.Signal.html">Phaser.Signal</a></span>
            ...
            <td class="description last"><p>This event is dispatched when this Animation loops.</p></td>
        </tr>
...
<span class="param-type"><a href="Phaser.Signal.html">Phaser.Signal</a></span>
            ...
            <td class="description last"><p>This event is dispatched when this Animation starts playback.</p></td>
        </tr>
...
<span class="param-type">null</span>
            ...
            <td class="description last"><p>This event is dispatched when the Animation changes frame. By default this event is disabled due to its intensive nature. Enable it with: <code>Animation.enableUpdate = true</code>.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="generateFrameNames"><span class="type-signature">&lt;static> </span>generateFrameNames<span class="signature">(prefix, start, stop, <span class="optional">suffix</span>, <span class="optional">zeroPad</span>)</span><span class="type-signature"> &rarr; {array}</span></h4>
...
<dt>
    <h4 class="name" id="next"><span class="type-signature"></span>next<span class="signature">(<span class="optional">quantity</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="previous"><span class="type-signature"></span>previous<span class="signature">(<span class="optional">quantity</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="setFrame"><span class="type-signature"></span>setFrame<span class="signature">(<span class="optional">frameId</span>, <span class="optional">useLocalFrameIndex</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="stop"><span class="type-signature"></span>stop<span class="signature">(<span class="optional">resetFrame</span>, <span class="optional">dispatchComplete</span>)</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="updateFrameData"><span class="type-signature"></span>updateFrameData<span class="signature">(frameData)</span><span class="type-signature"></span></h4>
