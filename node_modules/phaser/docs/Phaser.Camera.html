...
<span class="param-type"><a href="Phaser.Rectangle.html">Phaser.Rectangle</a></span>
            ...
            <td class="description last"><p>Moving inside this Rectangle will not cause the camera to move.</p></td>
        </tr>
...
<span class="param-type">PIXI.DisplayObject</span>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Camera.js.html">core/Camera.js</a>, <a href="Camera.js.html#sunlight-1-line-105">line 105</a>
    </li></ul></dd>
...
<dd>
    ...
    <div class="description">
        <p>The Cameras position. This value is automatically clamped if it falls outside of the World bounds.</p>
    </div>
...
<span class="param-type"><a href="Phaser.Point.html">Phaser.Point</a></span>
            ...
            <td class="description last"><p>Gets or sets the cameras xy position using Phaser.Point object.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="roundPx"><span class="type-signature"></span>roundPx<span class="type-signature"></span></h4>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If a Camera has roundPx set to <code>true</code> it will call <code>view.floor</code> as part of its update loop, keeping its boundary to integer values. Set this to <code>false</code> to disable this from happening.</p></td>
        </tr>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Camera.js.html">core/Camera.js</a>, <a href="Camera.js.html#sunlight-1-line-75">line 75</a>
    </li></ul></dd>
...
<span class="param-type"><a href="Phaser.Sprite.html">Phaser.Sprite</a></span>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="Camera.js.html">core/Camera.js</a>, <a href="Camera.js.html#sunlight-1-line-86">line 86</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="unfollow"><span class="type-signature"></span>unfollow<span class="signature">()</span><span class="type-signature"></span></h4>
