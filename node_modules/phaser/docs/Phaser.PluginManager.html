...
<header>
    ...
    PluginManager
        ...
        <div class="class-description"><p>Phaser.PluginManager</p></div>
...
<dt>
    <h4 class="name" id="PluginManager"><span class="type-signature"></span>new PluginManager<span class="signature">(game)</span><span class="type-signature"></span></h4>
...
<span class="param-type">array</span>
            ...
            <td class="description last"><p>An array of all the plugins being managed by this PluginManager.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="add"><span class="type-signature"></span>add<span class="signature">(plugin, parameter)</span><span class="type-signature"> &rarr; {<a href="Phaser.Plugin.html">Phaser.Plugin</a>}</span></h4>
...
<dt>
    <h4 class="name" id="remove"><span class="type-signature"></span>remove<span class="signature">(plugin)</span><span class="type-signature"></span></h4>
