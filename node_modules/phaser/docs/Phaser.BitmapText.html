...
<dt>
    <h4 class="name" id="BitmapText"><span class="type-signature"></span>new BitmapText<span class="signature">(game, x, y, font, <span class="optional">text</span>, <span class="optional">size</span>)</span><span class="type-signature"></span></h4>
...
So if this BitmapText was in a Group that has x: 200, then this will be added to the cameraOffset.x</p>
    </div>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Set to true to fix this BitmapText to the Camera at its current world coordinates.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="tint"><span class="type-signature"></span>tint<span class="type-signature"></span></h4>
...
<table class="props table table-striped">
	...
	<tbody>
        ...
        <tr>
                ...
                <td class="name"><code>tint</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>The tint applied to the BitmapText. This is a hex value. Set to white to disable (0xFFFFFF)</p></td>
        </tr>
