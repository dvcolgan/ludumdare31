...
<header>
    ...
    RetroFont
        ...
        <div class="class-description"><p>Phaser.RetroFont</p></div>
...
<dt>
    <h4 class="name" id="RetroFont"><span class="type-signature"></span>new RetroFont<span class="signature">(game, key, characterWidth, characterHeight, chars, <span class="optional">charsPerRow</span>, <span class="optional">xSpacing</span>, <span class="optional">ySpacing</span>, <span class="optional">xOffset</span>, <span class="optional">yOffset</span>)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>Alignment of the text when multiLine = true or a fixedWidth is set. Set to RetroFont.ALIGN_LEFT (default), RetroFont.ALIGN_RIGHT or RetroFont.ALIGN_CENTER.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="frameData"><span class="type-signature"></span>frameData<span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Phaser.FrameData.html">Phaser.FrameData</a></span>
            ...
            <td class="description last"><p>The FrameData representing this Retro Font.</p></td>
        </tr>
...
<span class="param-type"><a href="Phaser.Game.html">Phaser.Game</a></span>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="RenderTexture.js.html">gameobjects/RenderTexture.js</a>, <a href="RenderTexture.js.html#sunlight-1-line-31">line 31</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="RenderTexture.js.html">gameobjects/RenderTexture.js</a>, <a href="RenderTexture.js.html#sunlight-1-line-36">line 36</a>
    </li></ul></dd>
...
<span class="param-type">PIXI.Matrix</span>
            ...
            <td class="description last"><p>The matrix that is applied when display objects are rendered to this RenderTexture.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="offsetX"><span class="type-signature">&lt;readonly> </span>offsetX<span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="offsetY"><span class="type-signature">&lt;readonly> </span>offsetY<span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="stamp"><span class="type-signature">&lt;readonly> </span>stamp<span class="type-signature"></span></h4>
...
<span class="param-type"><a href="Phaser.Image.html">Phaser.Image</a></span>
            ...
            <td class="description last"><p>The image that is stamped to the RenderTexture for each character in the font.</p></td>
        </tr>
...
<dt>
    <h4 class="name" id="buildRetroFontText"><span class="type-signature"></span>buildRetroFontText<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="pasteLine"><span class="type-signature"></span>pasteLine<span class="signature">(line, x, y, customSpacingX)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="RenderTexture.js.html">gameobjects/RenderTexture.js</a>, <a href="RenderTexture.js.html#sunlight-1-line-82">line 82</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="RenderTexture.js.html">gameobjects/RenderTexture.js</a>, <a href="RenderTexture.js.html#sunlight-1-line-57">line 57</a>
    </li></ul></dd>
...
<dt>
    <h4 class="name" id="updateOffset"><span class="type-signature"></span>updateOffset<span class="signature">(<span class="optional">xOffset</span>, <span class="optional">yOffset</span>)</span><span class="type-signature"></span></h4>
